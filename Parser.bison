...
function : TOKEN_FUNCTION_KEYWORD variable TOKEN_LPAREN TOKEN_RPAREN TOKEN_LCURL lines TOKEN_RCURL { $$ = createFunctionNode(DECLARE_VOID,$2,$6,NULL); }
       | TOKEN_FUNCTION_KEYWORD variable TOKEN_LPAREN TOKEN_RPAREN TOKEN_IMPLIES TOKEN_INT_KEYWORD TOKEN_LCURL lines TOKEN_RETURN_KEYWORD expr TOKEN_SEMI TOKEN_RCURL { $$ = createFunctionNode(DECLARE_INT, $2, $8, $10); }
       | TOKEN_FUNCTION_KEYWORD variable TOKEN_LPAREN TOKEN_RPAREN TOKEN_IMPLIES TOKEN_FLOAT_KEYWORD TOKEN_LCURL lines TOKEN_RETURN_KEYWORD expr TOKEN_SEMI TOKEN_RCURL { $$ = createFunctionNode(DECLARE_FLOAT, $2, $8, $10); }
       | TOKEN_FUNCTION_KEYWORD variable TOKEN_LPAREN TOKEN_RPAREN TOKEN_IMPLIES TOKEN_CHAR_KEYWORD TOKEN_LCURL lines TOKEN_RETURN_KEYWORD expr TOKEN_SEMI TOKEN_RCURL { $$ = createFunctionNode(DECLARE_CHAR, $2, $8, $10); }
       | TOKEN_FUNCTION_KEYWORD variable TOKEN_LPAREN TOKEN_RPAREN TOKEN_IMPLIES TOKEN_BOOL_KEYWORD TOKEN_LCURL lines TOKEN_RETURN_KEYWORD expr TOKEN_SEMI TOKEN_RCURL { $$ = createFunctionNode(DECLARE_BOOL, $2, $8, $10); };
